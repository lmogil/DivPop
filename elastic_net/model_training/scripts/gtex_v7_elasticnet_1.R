...
main <- function(snp_annot_file, gene_annot_file, genotype_file, expression_file,
                 ...
                 seed=NA, cis_window=1e6, alpha=1) {
  # Read in data----
  ...
  # Prepare output data----
  model_summary_file <- '/home/lauren/files_for_revisions_plosgen/en_v7/new_output_alphas/' %&% prefix %&% '_chr' %&% chrom %&% '_model_summaries1.txt'
  ...
  weights_file <- '/home/lauren/files_for_revisions_plosgen/en_v7/new_output_alphas/' %&% prefix %&% '_chr' %&% chrom %&% '_weights1.txt'
  weights_col <- c('gene_id', 'rsid', 'varID', 'ref', 'alt', 'beta')
  write(weights_col, file = weights_file, ncol = 6, sep = '\t')
  
  tiss_chr_summ_f <- '/home/lauren/files_for_revisions_plosgen/en_v7/new_output_alphas/' %&% prefix %&% '_chr' %&% chrom %&% '_tiss_chr_summary1.txt'
  ...
  covariance_file <- '/home/lauren/files_for_revisions_plosgen/en_v7/new_output_alphas/' %&% prefix %&% '_chr' %&% chrom %&% '_covariances1.txt'
