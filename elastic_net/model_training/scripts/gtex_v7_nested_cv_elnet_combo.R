...
main <- function(snp_annot_file, gene_annot_file, genotype_file, expression_file,
  ...
  # Prepare output data----
  model_summary_file <- '/home/lauren/files_for_revisions_plosgen/en_v7/new_output_dw/' %&% prefix %&% '_chr' %&% chrom %&% '_model_summaries_' %&% peer %&% '_peer_' %&% covar %&% 'pcs.txt'
  ...
  weights_file <- '/home/lauren/files_for_revisions_plosgen/en_v7/new_output_dw/' %&% prefix %&% '_chr' %&% chrom %&% '_weights_' %&% peer %&% '_peer_' %&% covar %&% 'pcs.txt'
  weights_col <- c('gene_id', 'rsid', 'varID', 'ref', 'alt', 'beta')
  write(weights_col, file = weights_file, ncol = 6, sep = '\t')
  
  tiss_chr_summ_f <- '/home/lauren/files_for_revisions_plosgen/en_v7/new_output_dw/' %&% prefix %&% '_chr' %&% chrom %&% '_tiss_chr_summary_' %&% peer %&% '_peer_' %&% covar %&% 'pcs.txt'
  ...
  covariance_file <- '/home/lauren/files_for_revisions_plosgen/en_v7/new_output_dw/' %&% prefix %&% '_chr' %&% chrom %&% '_covariances_' %&% peer %&% '_peer_' %&% covar %&% 'pcs.txt'
